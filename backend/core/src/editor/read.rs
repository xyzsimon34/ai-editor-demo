...
pub use crate::editor::xml_structure::{
    debug_doc_structure, get_doc_xml_structure, get_text_refs_in_paragraph,
};
...
pub use crate::editor::xml_structure::collect_text_nodes_from_elem;
